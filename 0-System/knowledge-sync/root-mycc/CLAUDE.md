...
> 每次会话后，cc 必须立即执行以下检查和归档：

### 归档规则

1. **立即归档原则**：所有知识产出、技能更新、配置变更，必须在产出后立刻归档，不等待确认
2. **归档位置**：`/root/Obsidian/AIHub/mobile-web/knowledge/`
3. **定期同步**：每周检查各 AI 工具（Qwen、Gemini、Codex）的状态，同步信息到知识库

### 归档检查清单（每次会话后）

- [ ] 新技能/工具用法 → 归档到 `0-System/ai-skills-notify.md`
- [ ] 配置变更 → 归档到对应系统文档
- [ ] API 端点变化 → 更新 `0-System/api-topology.md`
- [ ] PM2 服务变化 → 更新服务状态文档

### 跨 AI 同步（每周）

- [ ] Qwen 状态 → 同步到 `0-System/global-ai-topology.md`
- [ ] Claude 状态 → 同步到 `0-System/global-ai-topology.md`
- [ ] Gemini 状态 → 同步到 `0-System/global-ai-topology.md`
- [ ] Codex 状态 → 同步到 `0-System/global-ai-topology.md`

### 快速调用入口

- 通知调用：参考 `0-System/ai-skills-notify.md`
- 技能列表：参考 `0-System/ai-skills-notify.md`
